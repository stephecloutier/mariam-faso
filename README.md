...
* présentation de l'ASBL et ses objectifs,
* _photo de membres ?_;

__Projets__
* présentation des réalisation passées, actuelles et futurs de l'association;
* _donner des chiffres quant aux coûts et temps de réalisations ?_ ;
* lien vers la page "témoignages de voyages" ;
* intégration de vidéos et photos ;

__Témoignages de voyages__
 * portfolio de voyages, comptes rendus, récits et présentation de projets ayant eu lieu ;
 * lien vers la page "voyage avec nous" ;
 * intégration de vidéos et photos ;
...
__Actualités__
* dernières nouvelles, mise en avant d'informations * actualisées et de promotions ;
* en relation avec la page Facebook ;

__Agenda__
* événements et activités en relation avec la page Facebook ;
* événements annuels récurrents (souper, souper spectacles, marche) ;

__Dons__
* avantages fiscaux dans les donations, appartenance à le * Fondation Roi Beaudoin,
* _intégrer le formulaire de donations ?_ ;
