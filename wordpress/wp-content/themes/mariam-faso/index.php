    ...
    <main class="main">
        ...
        <section class="main__help help">
            ...
            <div class="help__links">
                <a href="<?php mf_get_page_url('template-help.php'); ?>" class="help__link">Faire un don</a>
                <a href="<?php mf_get_page_url('archive-events.php'); ?>" class="help__link">Participer à nos évènements</a>
