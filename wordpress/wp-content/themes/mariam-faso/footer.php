<footer class="footer">
    <div class="footer__questions">
        ...
        <a href="<?php mf_get_page_url('template-contact'); ?>" class="footer__button--contact"><?= __('Contactez-nous', 'mf'); ?></a>
    </div>
    <div class="footer__help">
        ...
        <a href="<?php mf_get_page_url('template-help'); ?>" class="footer__button--donate"><?= __('Faire un don', 'mf'); ?></a>
    </div>
