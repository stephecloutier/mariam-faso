...
<main class="main">
    <div class="press">
        <div class="press__introduction introduction">
            ...
            <p class="introduction__content main-intro"><?= __('À plusieurs reprises, l’ASBL Mariam Faso est mentionnée dans la presse pour ses projets et voyages en Afrique, plus précisément au Burkina Faso et au Maroc.', 'mf'); ?></p>
        </div>
